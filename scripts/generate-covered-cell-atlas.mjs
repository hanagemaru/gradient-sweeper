...
const SHAPES = [
  ...
  // 背景ワールド用の大型形状。内角素材は C10(tr) と C11(bl) しかなく、
  // 回転・反転も使わないため、凹みは右上と左下だけ（左上から右下へ降りる階段）に限られる。
  {
    ...
    top: [[0, 448, 0]], bottom: [[0, 448, 160]],
    left: [[0, 160, 0]], right: [[0, 160, 448]],
  ...
  },
  {
    ...
    top: [[0, 192, 0]], bottom: [[0, 192, 384]],
    left: [[0, 384, 0]], right: [[0, 384, 192]],
  ...
  },
  {
    ...
    top: [[0, 256, 0], [256, 448, 96]],
    bottom: [[0, 128, 160], [128, 448, 288]],
    left: [[0, 160, 0], [160, 288, 128]],
    right: [[0, 96, 256], [96, 288, 448]],
  ...
  },
  {
    ...
    top: [[0, 320, 0], [320, 576, 112]],
    bottom: [[0, 160, 192], [160, 576, 320]],
    left: [[0, 192, 0], [192, 320, 160]],
    right: [[0, 112, 320], [112, 320, 576]],
